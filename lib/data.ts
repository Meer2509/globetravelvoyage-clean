...
export const services: Service[] = [
  ...
  { slug: "hotels", title: "Hotels & Luxury Stays", description: "5-star hotels, boutique stays, serviced apartments and long-stay rentals.", href: "/future-services#hotels", icon: "hotel", emoji: "🏨", accent: "from-gold/20 to-gold/5" },
  ...
  { slug: "car-rentals", title: "Car Rentals", description: "Economy to luxury cars with or without a chauffeur in 90+ countries.", href: "/future-services#car-rentals", icon: "car", emoji: "🚗", accent: "from-blue/20 to-blue/5" },
  { slug: "cruises", title: "Cruises & Ships", description: "Ocean cruises, river voyages, luxury liners and private ship charters.", href: "/future-services#cruises", icon: "cruise", emoji: "🛳️", accent: "from-gold/20 to-gold/5" },
  { slug: "yachts", title: "Boats & Yacht Tours", description: "Private yacht charters, sunset cruises and island-hopping boat tours.", href: "/future-services#cruises", icon: "yacht", emoji: "⛵", accent: "from-navy/20 to-navy/5" },
  { slug: "tours", title: "Local Tours", description: "Guided experiences led by verified local guides worldwide.", href: "/future-services#tours", icon: "tour", emoji: "🗺️", accent: "from-blue/20 to-blue/5" },
  { slug: "tickets", title: "Attraction Tickets", description: "Skip-the-line tickets to the world's top landmarks and attractions.", href: "/future-services#tickets", icon: "ticket", emoji: "🎟️", accent: "from-gold/20 to-gold/5" },
  ...
  { slug: "local-guides", title: "Tour Guides", description: "Book certified local guides for private or group tours.", href: "/future-services#tours", icon: "guide", emoji: "🧑‍🦯", accent: "from-navy/20 to-navy/5" },
  ...
  { slug: "insurance", title: "Travel Insurance", description: "Multi-trip and single-trip travel insurance options for global coverage.", href: "/future-services#insurance", icon: "insurance", emoji: "🛡️", accent: "from-navy/20 to-navy/5", badge: "Request quote" },
...
export const trustItems: TrustItem[] = [
  ...
  { icon: "star", emoji: "⭐", title: "Verified Reviews", text: "Reviews from completed bookings only. No pay-to-rank or fabricated ratings." },
...
export const stats: Stat[] = [
  ...
  { value: "Open", label: "Now accepting verified providers", icon: "🚀" },
