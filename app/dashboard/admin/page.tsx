        ...
        <Panel title="Intake consoles">
          <div className="grid gap-2 sm:grid-cols-2">
            {[
              ...
              { href: "/admin/group-tours", label: "Group tours" },
              ...
              { href: "/admin/verification", label: "Verification & trust" },
              { href: "/admin/acquisition", label: "Provider acquisition" },
              { href: "/admin/growth", label: "Growth & conversion" },
